...
parser.add_argument('--dataroot', default='./images/animal-painting', help='path to dataset')
...
parser.add_argument('--outf', default='./out/animal_out', help='folder to output images and model checkpoints')
    ...
    for i, data in enumerate(dataloader, 0):
        ...
        if i % 100 == 0:
            ...
            vutils.save_image(fake.detach(),
                    ...
                    normalize=True)
            # real_imgs = torch.cat((real_imgs, real_cpu))

    # do checkpointing
    torch.save(netG.state_dict(), '%s/netG_epoch_%d.pth' % (opt.outf, epoch))
    torch.save(netD.state_dict(), '%s/netD_epoch_%d.pth' % (opt.outf, epoch))

get_inception_score(netG(fixed_noise), 'Generated ')
